...
由于计算机以2为基数存储值，因此可能存在在基数为10的系统中通常表示的浮点值表示问题。阅读[docs.python.org/2/tutorial/floatingpoint.html](http://docs.python.org/2/tutorial/floatingpoint.html)以进一步讨论此限制的影响。
